...
def main() -> None:
    ...
    cases = [
        # Local prompt extraction regression case: pre-fix C++ emitted 74 frames.
        (149, 4, 2, 2, 1, 75),
        # Nearby lengths protect the ceil boundary on both sides.
        (148, 4, 2, 2, 0, 74),
        (150, 4, 2, 2, 0, 75),
        (151, 4, 2, 2, 1, 76),
        # Earlier encoder-style strides should also stay shape-compatible.
        (24000, 8, 4, 4, 0, 6000),
        (24001, 8, 4, 4, 3, 6001),
    ]
