...
struct ops {
    ...
    static struct ggml_cgraph * build_code_pred_greedy_graph_impl(TTSTransformer & self, struct ggml_context ** graph_ctx_out);
    ...
    static void release_cached_code_pred_greedy_graph(TTSTransformer & self);
    static bool ensure_cached_code_pred_greedy_graph(TTSTransformer & self);
