...
| Remaining CUDA throughput work | Active | Continue from `docs/performance_roadmap.md`; next candidates are decoder Flash Attention and Snake fusion, evaluated independently. |
